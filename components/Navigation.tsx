    ...
    <header className="bg-beige/85 backdrop-blur-md border-b border-beige-300 sticky top-0 z-50">
      <nav className="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2.5 group">
          ...
          <div>
            <div className="font-serif font-bold text-brun text-lg leading-tight group-hover:text-terracotta transition-colors">Parent IA</div>
