...
export const alt = "Parent IA — Grandir avec l'IA"
...
export default async function OgImage({ params }: { params: { slug: string } }) {
  ...
  const titre = article?.frontmatter.titre ?? 'Parent IA'
  ...
  // Taille de titre adaptée à la longueur et à la place disponible
      ...
      >
        ...
        >
          ...
          <div style={{ display: 'flex', fontSize: 24, color: '#8B7B6B' }}>
            parent-ia.fr · Grandir avec l&apos;IA
          </div>
        </div>

        {/* Photo polaroïd de l'activité */}
        {photo && (
          <div
            style={{
              display: 'flex',
