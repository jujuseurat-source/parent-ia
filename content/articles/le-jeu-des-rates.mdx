...
Ce processus s'appelle l'entraînement par rétropropagation, mais l'idée est simple : chaque erreur contient une information sur comment s'améliorer. L'erreur n'est pas un problème. Elle est la matière première de l'apprentissage.

Ce qui est troublant, c'est le nombre d'essais. Un enfant apprend à viser en quelques dizaines d'essais. Une IA peut avoir besoin de millions d'exemples pour apprendre à reconnaître un chat. Ce qui est rapide pour l'humain est lent pour la machine, et inversement.
...
La plupart des enfants répondent intuitivement : j'ai lancé trop fort, j'ai lancé trop à gauche, j'ai visé trop haut. Ce sont des informations sur l'erreur. Et c'est exactement ce qu'on donne à une IA quand on la corrige.
...
Romane avait une stratégie. Elle lançait doucement le premier coup pour avoir un point de repère, puis elle ajustait progressivement. Elle a dit que c'était *"comme apprendre à vélo mais en plus long"*, ce qui m'a semblé une très bonne description de la descente de gradient.
