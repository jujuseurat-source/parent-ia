...
<Image
  src="/images/articles/le-cahier-secret.jpg"
  alt="Le cahier secret de Romane, avec une serrure dessinée en rouge sur la couverture"
  width={800}
  height={600}
  className="rounded-xl mx-auto my-6 shadow-md"
/>

<p className="text-center text-sm text-brun-lighter italic -mt-4 mb-6">Le cahier. La serrure en rouge. Je n'avais pas le droit de le lire.</p>
