...
image: "/images/articles/chouette-dijon.jpg"
...
<Image
  src="/images/articles/chouette-dijon.jpg"
  alt="La chouette de Dijon, usée par des siècles de frottements, à peine reconnaissable dans la pierre"
  width={600}
  height={800}
  className="rounded-xl mx-auto my-6 shadow-md"
/>

<p className="text-center text-sm text-brun-lighter italic -mt-4 mb-6">La vraie chouette. Pas de plumes, pas d'yeux. Juste une forme creusée dans la pierre.</p>
...
J'ai dit que si, elle existe. Mais que son cerveau avait reconstruit une version plus complète, plus nette,
